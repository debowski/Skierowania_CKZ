...
class App:
    ...
    def __init__(self):
        ...
        self.root.title("Skierowania 0.37")
        self.root.grid()
        self.root.columnconfigure(0, weight=0, minsize=500)
        self.root.columnconfigure(1, weight=1, minsize=400)
        self.root.rowconfigure(0, weight=1)

        # # Wczytanie listy zawodów z pliku JSON
        # self.zawody_dict = self.load_zawody("zawody.json")
    ...
    def dodaj_widzety(self):
        ...
        self.data_wystawienia = ttkb.DateEntry(self.frame, firstweekday=0)
        ...
        self.data_rozpoczecia = ttkb.DateEntry(self.frame)
        ...
        self.data_zakonczenia = ttkb.DateEntry(self.frame)
        ...
        self.btn_otworz_folder_wykaz = ttkb.Button(
            self.frame, text="Otwórz folder wykazy", command=self.otworz_folder_wykazy
        )
